                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                      ...
                      {user.role === ROLES.SUPER_ADMIN && (
                        <DropdownMenuItem onClick={() => window.location.assign('/admin-panel')}>
                          <Shield className="mr-2 h-4 w-4" />Admin Panel
                        </DropdownMenuItem>
                      )}
                      {(user.role === ROLES.REPORTER || user.role === ROLES.SUPER_ADMIN) && (
                        <DropdownMenuItem onClick={() => window.location.assign('/reporter-panel')}>
                          <Newspaper className="mr-2 h-4 w-4" />{t('reporterDashboard')}
                        </DropdownMenuItem>
                      )}
                      <DropdownMenuSeparator />
